...
<layout:main>
	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript">
			...
			${script}
			var start_date = '${verFrmwr.start_date}'=='' ? '' : '${verFrmwr.start_date}';
			$(document).ready(function(){
				...
				$("#btnRegister").click(function() {
					...
					$.ajax({
						...
						type : "POST",
					    cache: false,						
						url : "/manage/checkBetaVerFrmwrFormData",
						dataType : "json",
						data : { "cpCode" : "001", "verNum" : verNum}
					})
	...
	<jsp:body>
		...
		<div class="boardTitle">
			<div class="borderTitle">
				<span class="pageTitle">테스트 단말 펌웨어 버전관리 등록</span>
			</div>
		</div>
		<table class="tbl_1">
			<caption></caption>
			...
			<tbody>
				<form name="registerForm" method="post" action="/manage/betaVerFrmwrRegister">
					...
					<tr>
						<th>단말 버전 설명</th>
						<td colspan="3">
							<textarea id="verTitle" name="verTitle" rows="10" style="border:1px solid #ccc;width:98%" require="true" msg="내용을 입력하셔야 합니다.">${verFrmwr.verMemo }</textarea>
						</td>					
					</tr>
				</form>
		</table>			
