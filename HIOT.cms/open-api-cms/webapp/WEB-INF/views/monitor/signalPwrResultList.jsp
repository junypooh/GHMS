...
<layout:main>
		...
		<script type="text/javascript">			
			...
			$(document).ready(function() {
				...
				$("#btnSearch").click(function() {
					...
					form.action="/monitor/signalPwrResultList"
					form.submit();
				});		
				...
				$("#btnDownload").click(function() {
					...
					var form = document.forms["searchForm"];
					form.action="/monitor/signalPwrResultList.download"
					form.submit();
				});	
	...
	<jsp:body>
		...
		<div class="boardTop">	
			<table>
			<form name="searchForm" method="get" action="/monitor/signalPwrResultList">
				<colgroup>
		...
		<table class="board mt10">
			...
			<thead>
				<tr>
					...
					<th scope="col" rowspan="2" style="BORDER-right: #B7B7B7 1px solid;">olleh ID</th>
					<th scope="col" rowspan="2" style="BORDER-right: #B7B7B7 1px solid;">카메라 ID</th>
					<th scope="col" rowspan="2" style="BORDER-right: #B7B7B7 1px solid;">카메라 닉네임<br>/ 카메라 mac</th>
			...
			<c:if test="${!empty signalResultList}">
				...
				<tr data-pk="${notice.pk}" onmouseover="this.style.backgroundColor='#f7f7f7'" onmouseout="this.style.backgroundColor=''" bgcolor="white">
					...
					<td>${signalResult.devNm}<br>${signalResult.devCctvMac}</td>
