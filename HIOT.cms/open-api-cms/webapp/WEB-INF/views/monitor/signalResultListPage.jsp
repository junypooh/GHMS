	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript">			
			...
			function SearchCam(){
				...
				form.action="/monitor/signalResultListPage";
				form.submit();
			}
		</script>	
		...
		<table class="board mt10">
			...
			<script>
				$(document).ready(function() {
					...
					$("#btnSearchLog").click(function() {
						...
						form.target="screen";
						form.action="/monitor/signalResultListPageLog";
						form.submit();
					});		
					...
					$("#btnDownload").click(function() {
						...
						//form.target="screen";
						form.action="/monitor/signalResultListPageLog.download";
						form.submit();
					});	
			...
			<tr>
				<td colspan="8">
					...
					<input type="hidden" id="submitType" name="submitType" value="page">
					
					<table style="width:100%; border:solid 1px; border-color:#E8E8E8;">
						<tr>
							<td style="font-weight:bold; text-align:center;">
								<select id="searchLogType" name="searchLogType" style="width:150px">
