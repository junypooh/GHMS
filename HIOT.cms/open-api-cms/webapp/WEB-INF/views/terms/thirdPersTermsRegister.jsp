...
<layout:main>
		...
		<script type="text/javascript">
			...
			function checkVersion() {
				...
				$.ajax({
					type : "GET",
				    cache: false,						
					url : "/terms/checkThirdTermsFormData",
					dataType : "json",
	...
	<jsp:body>
		...
		<h2 class="pageTitle">제3자 취급위탁 약관 등록</h2>
		<table class="tbl_1">
			<caption></caption>
			<colgroup>
				<col style="width:15%" />
			...
			<tbody>
				<form id="registerForm" name="registerForm" method="post" action="/terms/thirdPersTermsRegister">
