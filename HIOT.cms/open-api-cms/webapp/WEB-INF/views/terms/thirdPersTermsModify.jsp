...
<layout:main>
	...
	<jsp:body>
		<form name="transForm" method="get" action="/terms/thirdPersTermsList">
		...
		<div class="boardTitle">
			<div class="borderTitle">
				<span class="pageTitle">제3자 취급위탁 약관 수정</span>
			</div>
		</div>
		<table class="tbl_1">
			<caption></caption>
			...
			<tbody>
				<form id="modifyForm" name="modifyForm" method="post" onsubmit="return false;" action="/terms/thirdPersTermsModify">
				...
				<tr>
					...
					<td colspan="3"><input type="text" id="title" name="title" value="${termsMap.title}" class="w330" require="true" msg="제목을 입력하셔야 합니다." /></td>
				</tr>
				<tr>
