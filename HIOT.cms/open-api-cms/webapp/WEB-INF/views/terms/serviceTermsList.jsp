...
<layout:main>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$("#btnToggle").click(function(){
					...
					$("#serviceTermsListContainer input[type=checkbox]").each(function(index){
				...
				$("#btnRemove").click(function() {
					var pkList = "";
					$("#serviceTermsListContainer tr input[type=checkbox]").each(function(index) {
				...
				$("#btnWrite").click(function(){
					location.href = "/terms/serviceTermsRegister";
				});
	...
	<jsp:body>
		<form name="searchForm" method="get" action="/terms/serviceTermsList">
		<div class="boardTitle">
			<div class="borderTitle">
				<span class="pageTitle">서비스 이용약관</span>
		...
		<table class="board mt10">
			...
			<c:if test="${!empty termsList}">
				...
				<tr data-pk="${terms.pk}" onmouseover="this.style.backgroundColor='#f7f7f7'" onmouseout="this.style.backgroundColor=''" bgcolor="white">
					...
					<td>${terms.cpName }</td>
					<td>
						&nbsp;<a href="/terms/serviceTermsModify?pk=${terms.pk }&page=${param.page}&cpCode=${param.cpCode}" onfocus="this.blur();">${terms.title}</a>
					</td>
