...
<layout:main>
	...
	<jsp:attribute name="javascript">
		<script type="text/javascript">
			...
			var nomoreYN= '${notice.nomoreYN}';
			var popupType = '${notice.popupType}';
			
			$(document).ready(function(){
				
				$("#nomoreYN").val(nomoreYN);
				$("#popupType").val(popupType);
	...
	<jsp:body>
		...
		<table class="tbl_1">
			...
			<tbody>
				<form name="modifyForm" method="post" action="/customer/popupNoticeModify">
				...
				<tr>
					...
					<th>
						<div id= "start_div">	
							...
							<!-- <img src="../resources/images/callender.png" id="img_start_date" /> --> 
							&nbsp;&nbsp;&nbsp;&nbsp;									
						...
						<div id= "end_div">
							...
							<!-- <img src="../resources/images/callender.png" id="img_end_date" />  -->
							&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>	
					...
					<td>
						<select id="nomoreYN" name= "nomoreYN">
					...
					<td>
						<select id= "popupType" name= "popupType">
							<c:forEach var="type" items="${typeList}">
								<option value="${type.code}">${type.memo}</option>
							</c:forEach>
