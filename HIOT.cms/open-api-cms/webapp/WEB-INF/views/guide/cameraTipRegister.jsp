...
<layout:main>
			...
			$(document).ready(function(){
				...
				$("#btnRegister").click(function() {
					...
					if(openYN == 'Y'){
						$.ajax({
							...
							type : "POST",
						    cache: false,						
							url : "/guide/checkCameraTipFormData",
							dataType : "json",
				...
				$("#cpCode").change(function(){
					...
					$.ajax({
						type : "POST",
					    cache: false,						
						url : "/guide/getCameraTipVersionList",
						dataType : "json",
						data : { "cpCode" : cpCode }
					})
					.done(function(result){
	...
	<jsp:body>
		...
		<table class="tbl_1">
			...
			<tbody>
				<form id="registerForm" name="registerForm" method="post" onsubmit="return false;" action="/guide/cameraTipRegister" enctype="multipart/form-data">
