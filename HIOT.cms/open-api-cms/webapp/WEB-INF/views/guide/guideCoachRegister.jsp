				...
				$("#btnRegister").click(function() {
					...
					if(openYN == 'Y'){
						$.ajax({
							...
							type : "POST",
						    cache: false,						
							url : "/guide/checkCoachFormData",
							dataType : "json",
							data : { "cpCode" : cpCode, "verNum" : verNum, "positionCode" : positionCode}
						})
						.done(function(result){
							if(result.code == 200) { submitFg = true; }
							else if(result.code == 300) { 
								if(confirm("상품/앱버전/위치가 같은 정보가 있을경우\n비노출로 등록됩니다.\n진행하시겠습니까?")){
	...
	<jsp:body>
		...
		<div class="boardTitle">
			<div class="borderTitle">
				<span class="pageTitle">코치가이드 등록</span>
			</div>
		</div>
		...
		<table class="tbl_1">
			...
			<tbody>
				<form id="registerForm" name="registerForm" method="post" onsubmit="return false;" action="/guide/guideCoachRegister" enctype="multipart/form-data">
