package com.kt.health.smcp.gw.ca.domn.spotdev;
...
import com.kt.health.smcp.gw.ca.comm.GwCode.DevCnctType;
import com.kt.health.smcp.gw.ca.comm.GwCode.SpotDevSttus;
import com.kt.health.smcp.gw.ca.comm.GwCode.SpotDevSubsSttus;
import com.kt.health.smcp.gw.ca.comm.GwCode.UseYn;
import com.kt.smcp.gw.ca.domn.CorePrcssData;
import com.kt.smcp.gw.ca.query.spotdev.vo.SpotDevBasVO.SpotDevDtlVO;

@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class SpotDevBasVO extends CorePrcssData implements Serializable, Cloneable
{
	/** 직렬화아이디 */
	...
	/**장치연결유형코드 (DevCnctType)  */
	private String devConnTypeCd;
	/** 상태코드 (SpotDevSttus) */
	private String sttusCd;
	/** 현장장치개통상태 (SpotDevSubsSttusCd) */
	private String spotDevSubsSttusCd;
	/** 수집주기시간 */
	...
	/** 추가속성여부 (UseYn) */
	private String apdAtribYn;
	/** 사용여부 (UseYn) */
	private String useYn;
	/** 삭제여부 (UseYn) */
	private String delYn;
	
	private List<SpotDevDtlVO> SpotDevDtlVOs;  
	...
	public SpotDevBasVO(SpotDevBasVO spotDevBas)
	{
		/** 서비스대상일련번호 */
		...
		if(spotDevBas.getUseYn() != null)
		{
			...
			this.setUseYn(spotDevBas.getUseYn());
		}
	}

	public void update(SpotDevBasVO spotDev)
	{
		/** 서비스대상일련번호 */
		...
		if(spotDev.getUseYn() != null)
		{
			...
			this.setUseYn(spotDev.getUseYn());
		}
	}
	...
	{
		if( !(obj instanceof SpotDevBasVO) )
		{
			return false;
		}

		SpotDevBasVO spotDevBas = (SpotDevBasVO)obj;
...
//	}
	...
	// Original Type : SpotDevSubsSttus
	/**
	...
	public void setSubsSttusCd(String subsSttusCd) {
		this.subsSttusCd = subsSttusCd; // SpotDevSubsSttus.fromString(subsSttusCd);
	}
	...
	public void setConnYn(String connYn) {
		this.connYn = connYn; // UseYn.fromString(connYn);
	}
	...
	public void setDevConnTypeCd(String devConnTypeCd) {
		this.devConnTypeCd = devConnTypeCd; // DevCnctType.fromString(devConnTypeCd);
	}


	// Original Type  : SpotDevSttus
	/**
	 * @return the sttusCd
	 */
	...
	public void setSttusCd(String sttusCd) {
		this.sttusCd = sttusCd; // SpotDevSttus.fromString(sttusCd);
	}

	// Original Type : SpotDevSubsSttusCd
	public String getSpotDevSubsSttusCd() {
		return spotDevSubsSttusCd;
	}

	// Original Type : SpotDevSubsSttusCd
	public void setSpotDevSubsSttusCd(String spotDevSubsSttusCd) {
		this.spotDevSubsSttusCd = spotDevSubsSttusCd; //SpotDevSubsSttus.fromString(spotDevSubsSttusCd);
	}
	...
	public void setApdAtribYn(String apdAtribYn) {
		this.apdAtribYn = apdAtribYn; // UseYn.fromString(apdAtribYn);
	}
	...
	public void setUseYn(String useYn) {
		this.useYn = useYn; // UseYn.fromString(useYn);
	}
	...
	public void setDelYn(String delYn) {
		this.delYn = delYn; // UseYn.fromString(delYn);
	}
