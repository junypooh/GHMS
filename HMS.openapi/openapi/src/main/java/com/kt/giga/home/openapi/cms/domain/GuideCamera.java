...
public class GuideCamera {
	private String	pk_guide_camera;		// 카메라팁 pk        
	 ...
	 * @return 카메라팁 pk
	 */
	public String getPk_guide_camera() {
		return pk_guide_camera;
	}
	/**
	 * @param 카메라팁 pk
	 */
	public void setPk_guide_camera(String pk_guide_camera) {
		this.pk_guide_camera = pk_guide_camera;
	}
	/**
	 * @return 서비스 구분코드
	 */
