 ...
 * @author
 */
@Service("HCam.RelayControlService")
public class RelayControlService {
    ...
    public Callable<Map<String, String>> getRelaySession(final String authToken, final String devUUID) throws Exception {

        return new Callable<Map<String, String>>() {

            @Override
            public Map<String, String> call() throws Exception {
                return getIntegratedRelaySession(authToken, devUUID);
            }
        };
    }

    public Map<String, String> getIntegratedRelaySession(String authToken, final String devUUID) throws Exception {
        try {
            AuthToken loginAuthToken = userService.checkLoginAuthToken(authToken);

            List<SpotDev> spotDevList = deviceDao.getMemberSpotDev(loginAuthToken.getSvcCode(), loginAuthToken.getUserNoLong(), devUUID, null, null);
            ...
            Callable<Map<String, String>> callable = deviceService.getGenlSetupConfig(authToken, spotDevList);
