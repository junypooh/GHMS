 ...
 *
 */
public class GuideCoach {
	private String	pk_guide_coach;			// 코치가이드 pk        
	private String	fd_cp_code;				// 서비스 구분코드
	private String	fd_position_code;		// 노출 위치 구분코드
	private String	fd_title;				// 코치가이드 제목       
	private String	fd_contents;			// 코치가이드 내용  
	 ...
	 * @return 코치가이드 pk
	 */
	public String getPk_guide_coach() {
		return pk_guide_coach;
	}
	/**
	 * @param 코치가이드 pk
	 */
	public void setPk_guide_coach(String pk_guide_coach) {
		this.pk_guide_coach = pk_guide_coach;
	}
	/**
	 * @return 서비스 구분코드
	 */
