...
import com.kt.smcp.gw.ca.comm.GwCode.CnctType;
import com.kt.smcp.gw.ca.comm.GwCode.CommChTrtType;
import com.kt.smcp.gw.ca.comm.GwCode.CommChType;
import com.kt.smcp.gw.ca.comm.GwCode.CommDataTrtModeType;
import com.kt.smcp.gw.ca.comm.GwCode.DataProtType;
import com.kt.smcp.gw.ca.comm.GwCode.EcodType;
import com.kt.smcp.gw.ca.comm.GwCode.IfType;
import com.kt.smcp.gw.ca.comm.GwCode.UseYn;

public class SpotDevCommChDtl implements Serializable, Cloneable
{
	/** 직렬화아이디 */
	private static final long serialVersionUID = 4279494007282667603L;
	...
	/** 일련포트아이디 */
	private String srialPortId;
	/** 전송속도 */
	private Integer trmSpeed;
	/** 데이터비트코드 */
	private String dataBitCd;
	/** 정지비트코드 */
	private String stopBitCd;
	/** 점검비트코드 */
	private String chkBitCd;
	/** 흐름제어코드 */
	private String flowContlCd;
	/** 연결타임아웃시간 */
	...
	/**
	 * @return the srialPortId
	 */
	public String getSrialPortId() {
		return srialPortId;
	}
	/**
	 * @param srialPortId the srialPortId to set
	 */
	public void setSrialPortId(String srialPortId) {
		this.srialPortId = srialPortId;
	}
	/**
	 * @return the trmSpeed
	 */
	public Integer getTrmSpeed() {
		return trmSpeed;
	}
	/**
	 * @param trmSpeed the trmSpeed to set
	 */
	public void setTrmSpeed(Integer trmSpeed) {
		this.trmSpeed = trmSpeed;
	}
	/**
	 * @return the dataBitCd
	 */
	public String getDataBitCd() {
		return dataBitCd;
	}
	/**
	 * @param dataBitCd the dataBitCd to set
	 */
	public void setDataBitCd(String dataBitCd) {
		this.dataBitCd = dataBitCd;
	}
	/**
	 * @return the stopBitCd
	 */
	public String getStopBitCd() {
		return stopBitCd;
	}
	/**
	 * @param stopBitCd the stopBitCd to set
	 */
	public void setStopBitCd(String stopBitCd) {
		this.stopBitCd = stopBitCd;
	}
	/**
	 * @return the chkBitCd
	 */
	public String getChkBitCd() {
		return chkBitCd;
	}
	/**
	 * @param chkBitCd the chkBitCd to set
	 */
	public void setChkBitCd(String chkBitCd) {
		this.chkBitCd = chkBitCd;
	}
	/**
	 * @return the flowContlCd
	 */
	public String getFlowContlCd() {
		return flowContlCd;
	}
	/**
	 * @param flowContlCd the flowContlCd to set
	 */
	public void setFlowContlCd(String flowContlCd) {
		this.flowContlCd = flowContlCd;
	}
	/**
