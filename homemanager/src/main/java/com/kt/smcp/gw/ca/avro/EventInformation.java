...
public class EventInformation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.kt.smcp.gw.ca.avro.EventInformation.Builder newBuilder() {
    return new com.kt.smcp.gw.ca.avro.EventInformation.Builder();
  }
  
  /** Creates a new EventInformation RecordBuilder by copying an existing Builder */
  public static com.kt.smcp.gw.ca.avro.EventInformation.Builder newBuilder(com.kt.smcp.gw.ca.avro.EventInformation.Builder other) {
    return new com.kt.smcp.gw.ca.avro.EventInformation.Builder(other);
  }
  
  /** Creates a new EventInformation RecordBuilder by copying an existing EventInformation instance */
  public static com.kt.smcp.gw.ca.avro.EventInformation.Builder newBuilder(com.kt.smcp.gw.ca.avro.EventInformation other) {
    return new com.kt.smcp.gw.ca.avro.EventInformation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventInformation>
    ...
    private Builder() {
      super(com.kt.smcp.gw.ca.avro.EventInformation.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.kt.smcp.gw.ca.avro.EventInformation.Builder other) {
      super(other);
    ...
    private Builder(com.kt.smcp.gw.ca.avro.EventInformation other) {
            super(com.kt.smcp.gw.ca.avro.EventInformation.SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'eventId' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setEventId(java.lang.String value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearEventId() {
      eventId = null;
    ...
    /** Sets the value of the 'eventOutbId' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setEventOutbId(java.lang.String value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearEventOutbId() {
      eventOutbId = null;
    ...
    /** Sets the value of the 'eventName' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setEventName(java.lang.String value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearEventName() {
      eventName = null;
    ...
    /** Sets the value of the 'eventGrade' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setEventGrade(java.lang.String value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearEventGrade() {
      eventGrade = null;
    ...
    /** Sets the value of the 'svcTgtSeq' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setSvcTgtSeq(long value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearSvcTgtSeq() {
    ...
    /** Sets the value of the 'spotDevSeq' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setSpotDevSeq(long value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearSpotDevSeq() {
    ...
    /** Sets the value of the 'eventItems' field */
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder setEventItems(java.util.Map<java.lang.String,java.lang.Object> value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventInformation.Builder clearEventItems() {
      eventItems = null;
