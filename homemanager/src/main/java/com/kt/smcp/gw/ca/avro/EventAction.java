...
public class EventAction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EventAction(com.kt.smcp.gw.ca.avro.EventInformation eventInformation, java.util.List<com.kt.smcp.gw.ca.avro.ActionTask> actionTaskList) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: eventInformation = (com.kt.smcp.gw.ca.avro.EventInformation)value$; break;
    case 1: actionTaskList = (java.util.List<com.kt.smcp.gw.ca.avro.ActionTask>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.kt.smcp.gw.ca.avro.EventInformation getEventInformation() {
   ...
   */
  public void setEventInformation(com.kt.smcp.gw.ca.avro.EventInformation value) {
   ...
   */
  public java.util.List<com.kt.smcp.gw.ca.avro.ActionTask> getActionTaskList() {
   ...
   * @param value the value to set.
   */
  public void setActionTaskList(java.util.List<com.kt.smcp.gw.ca.avro.ActionTask> value) {
    this.actionTaskList = value;
  }

  /** Creates a new EventAction RecordBuilder */
  public static com.kt.smcp.gw.ca.avro.EventAction.Builder newBuilder() {
    return new com.kt.smcp.gw.ca.avro.EventAction.Builder();
  }
  
  /** Creates a new EventAction RecordBuilder by copying an existing Builder */
  public static com.kt.smcp.gw.ca.avro.EventAction.Builder newBuilder(com.kt.smcp.gw.ca.avro.EventAction.Builder other) {
    return new com.kt.smcp.gw.ca.avro.EventAction.Builder(other);
  }
  
  /** Creates a new EventAction RecordBuilder by copying an existing EventAction instance */
  public static com.kt.smcp.gw.ca.avro.EventAction.Builder newBuilder(com.kt.smcp.gw.ca.avro.EventAction other) {
    return new com.kt.smcp.gw.ca.avro.EventAction.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventAction>
    ...
    private com.kt.smcp.gw.ca.avro.EventInformation eventInformation;
    private java.util.List<com.kt.smcp.gw.ca.avro.ActionTask> actionTaskList;

    /** Creates a new Builder */
    private Builder() {
      super(com.kt.smcp.gw.ca.avro.EventAction.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.kt.smcp.gw.ca.avro.EventAction.Builder other) {
      super(other);
    ...
    private Builder(com.kt.smcp.gw.ca.avro.EventAction other) {
            super(com.kt.smcp.gw.ca.avro.EventAction.SCHEMA$);
      if (isValidValue(fields()[0], other.eventInformation)) {
        this.eventInformation = data().deepCopy(fields()[0].schema(), other.eventInformation);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'eventInformation' field */
    public com.kt.smcp.gw.ca.avro.EventAction.Builder setEventInformation(com.kt.smcp.gw.ca.avro.EventInformation value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventAction.Builder clearEventInformation() {
    ...
    /** Sets the value of the 'actionTaskList' field */
    public com.kt.smcp.gw.ca.avro.EventAction.Builder setActionTaskList(java.util.List<com.kt.smcp.gw.ca.avro.ActionTask> value) {
    ...
    public com.kt.smcp.gw.ca.avro.EventAction.Builder clearActionTaskList() {
      actionTaskList = null;
    ...
    public EventAction build() {
      try {
        ...
        record.eventInformation = fieldSetFlags()[0] ? this.eventInformation : (com.kt.smcp.gw.ca.avro.EventInformation) defaultValue(fields()[0]);
        record.actionTaskList = fieldSetFlags()[1] ? this.actionTaskList : (java.util.List<com.kt.smcp.gw.ca.avro.ActionTask>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
