...
public class ComplexEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord, Serializable {
  ...
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder newBuilder() {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder();
  }

  /** Creates a new ComplexEvent RecordBuilder by copying an existing Builder */
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder newBuilder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder other) {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder(other);
  }

  /** Creates a new ComplexEvent RecordBuilder by copying an existing ComplexEvent instance */
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder newBuilder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent other) {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ComplexEvent>
    ...
    private Builder() {
      super(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder other) {
      super(other);
    ...
    private Builder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent other) {
            super(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.svcTgtSeq)) {
        this.svcTgtSeq = data().deepCopy(fields()[0].schema(), other.svcTgtSeq);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'svcTgtSeq' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder setSvcTgtSeq(long value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder clearSvcTgtSeq() {
    ...
    /** Sets the value of the 'evtOutbId' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder setEvtOutbId(java.lang.String value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder clearEvtOutbId() {
      evtOutbId = null;
    ...
    /** Sets the value of the 'evtId' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder setEvtId(java.lang.String value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder clearEvtId() {
      evtId = null;
    ...
    /** Sets the value of the 'items' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder setItems(java.util.Map<java.lang.String,java.lang.Object> value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ComplexEvent.Builder clearItems() {
      items = null;
