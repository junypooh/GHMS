...
import com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.comm.GwCode.SpotDevSttus;
import com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.comm.GwCode.SpotDevSubsSttus;
...
public class SpotDevBas extends CorePrcssData implements Serializable, Cloneable
{
	...
	/** 단위서비스코드 */
	private String unitSvcCd = "001HIT003"; // fix. 서비스별 변경 되지 않음.
	/**현장장치명  */
