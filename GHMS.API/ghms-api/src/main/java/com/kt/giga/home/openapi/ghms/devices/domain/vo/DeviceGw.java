...
public class DeviceGw {
	...
	public int getInternetRuleCnt() {
		return internetRuleCnt;
	}

	public void setInternetRuleCnt(int internetRuleCnt) {
		this.internetRuleCnt = internetRuleCnt;
	}
