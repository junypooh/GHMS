...
public class ActionTask extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder newBuilder() {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder();
  }

  /** Creates a new ActionTask RecordBuilder by copying an existing Builder */
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder newBuilder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder other) {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder(other);
  }

  /** Creates a new ActionTask RecordBuilder by copying an existing ActionTask instance */
  public static com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder newBuilder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask other) {
    return new com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ActionTask>
    ...
    private Builder() {
      super(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder other) {
      super(other);
    ...
    private Builder(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask other) {
            super(com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.SCHEMA$);
      if (isValidValue(fields()[0], other.actionCode)) {
        this.actionCode = data().deepCopy(fields()[0].schema(), other.actionCode);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'actionCode' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder setActionCode(java.lang.String value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder clearActionCode() {
      actionCode = null;
    ...
    /** Sets the value of the 'actionTarget' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder setActionTarget(java.lang.String value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder clearActionTarget() {
      actionTarget = null;
    ...
    /** Sets the value of the 'taskResources' field */
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder setTaskResources(java.util.Map<java.lang.String,java.lang.Object> value) {
    ...
    public com.kt.giga.home.openapi.ghms.kafka.smcp.gw.ca.avro.ActionTask.Builder clearTaskResources() {
      taskResources = null;
