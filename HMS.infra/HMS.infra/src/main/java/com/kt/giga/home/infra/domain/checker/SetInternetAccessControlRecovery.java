...
/**
 * AP 인터넷 이용제한 룰 복구 Request
 * @author junypooh ( kyungjun.park@ceinside.co.kr )
 * @since 2015. 6. 8.
 */
@XmlRootElement(name="SetInternetAccessControlRecovery", namespace="http://tempuri.org/")
public class SetInternetAccessControlRecovery extends HttpSoapObjectRequest {
