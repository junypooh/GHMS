...
public class ComplexEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ComplexEvent\",\"namespace\":\"com.kt.iot.core.integration.avro\",\"fields\":[{\"name\":\"svcTgtSeq\",\"type\":\"long\"},{\"name\":\"evtOutbId\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"evtId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"items\",\"type\":{\"type\":\"map\",\"values\":[\"int\",\"long\",\"float\",\"double\",{\"type\":\"string\",\"avro.java.string\":\"String\"},\"boolean\"],\"avro.java.string\":\"String\"}}]}");
  ...
  public static ComplexEvent.Builder newBuilder() {
    return new ComplexEvent.Builder();
  }
  
  /** Creates a new ComplexEvent RecordBuilder by copying an existing Builder */
  public static ComplexEvent.Builder newBuilder(ComplexEvent.Builder other) {
    return new ComplexEvent.Builder(other);
  }
  
  /** Creates a new ComplexEvent RecordBuilder by copying an existing ComplexEvent instance */
  public static ComplexEvent.Builder newBuilder(ComplexEvent other) {
    return new ComplexEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ComplexEvent>
    ...
    private Builder() {
      super(ComplexEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(ComplexEvent.Builder other) {
      super(other);
    ...
    private Builder(ComplexEvent other) {
            super(ComplexEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.svcTgtSeq)) {
        this.svcTgtSeq = data().deepCopy(fields()[0].schema(), other.svcTgtSeq);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'svcTgtSeq' field */
    public ComplexEvent.Builder setSvcTgtSeq(long value) {
    ...
    public ComplexEvent.Builder clearSvcTgtSeq() {
    ...
    /** Sets the value of the 'evtOutbId' field */
    public ComplexEvent.Builder setEvtOutbId(java.lang.String value) {
    ...
    public ComplexEvent.Builder clearEvtOutbId() {
      evtOutbId = null;
    ...
    /** Sets the value of the 'evtId' field */
    public ComplexEvent.Builder setEvtId(java.lang.String value) {
    ...
    public ComplexEvent.Builder clearEvtId() {
      evtId = null;
    ...
    /** Sets the value of the 'items' field */
    public ComplexEvent.Builder setItems(java.util.Map<java.lang.String,java.lang.Object> value) {
    ...
    public ComplexEvent.Builder clearItems() {
      items = null;
