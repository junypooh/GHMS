 ...
 * @since 2015. 8. 20.
 */
@XmlRootElement(name = "getSpecificSubsAndUserInfoRequest", namespace = "http://kt.com/sdp")
public class SpecificSubsAndUserInfoRequest extends HttpSoapObjectRequest {
